...
import { RotateCcw, AlertCircle, Keyboard, Lock, Lightbulb } from "lucide-react";
import {
        ...
        <div>
          ...
          {!hasActiveLicense && (
            <p className="text-sm text-muted-foreground">
              Get a license to customize shortcuts
            </p>
          )}
        </div>
        ...
        <Card className="p-4 bg-primary/5 border-primary/20">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 space-y-2">
              ...
              <p className="text-3xs lg:text-xs text-muted-foreground">
