      ...
      {isExpanded && (
        <div className="px-3 pb-3 space-y-3">
          ...
          <div className="space-y-2">
            ...
            <div className="p-2 rounded-md bg-primary/5 text-3xs text-muted-foreground space-y-1">
              <p>
          ...
          {/* Tips */}
          <div className="text-3xs text-muted-foreground space-y-1 pt-2 border-t border-border/50">
            <p>
