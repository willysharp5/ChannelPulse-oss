...
export const PermissionFlow = ({
  ...
  const stateConfig = {
    ...
    requesting: {
      ...
      description: `Enable ChannelPulse in System Settings (${checkAttempts}/20)`,
            ...
            <div className="mt-3 space-y-2">
              ...
              {showManual && (
                <ol className="text-xs text-muted-foreground space-y-1 list-decimal list-inside pt-2 border-t border-border/50">
                  ...
                  <li>Search for "Screen &amp; System Audio Recording"</li>
                  <li>Enable ChannelPulse in the list</li>
                </ol>
              )}
            </div>
          )}
