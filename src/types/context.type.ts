...
import { Entitlement } from "@/lib/trial";
...
export type IContextType = {
  ...
  togglePrivacyMode: (isEnabled: boolean) => Promise<void>;
  toggleAlwaysOnTop: (isEnabled: boolean) => Promise<void>;
  toggleAutostart: (isEnabled: boolean) => Promise<void>;
  loadData: () => void;
  channelpulseApiEnabled: boolean;
  setChannelPulseApiEnabled: (enabled: boolean) => Promise<void>;
